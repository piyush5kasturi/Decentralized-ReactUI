...
const About = () => {
    return (
        <div className='about' id="platform">
            <div className="container">
                <h2>A Growing Protocol Ecosystem</h2>
                <p>The Decentralized protocol system empowers developers, liquidity providers, and traders to participate in a financial marketplace that is open and accessible to all.</p>
                ...
                <a href="/" className="btn">Use Decentralized</a>
            </div>
        </div>
    )
}
